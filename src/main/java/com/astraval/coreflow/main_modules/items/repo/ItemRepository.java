...
public interface ItemRepository extends JpaRepository<Items, Long> {
    ...
    @Query("SELECT new com.astraval.coreflow.main_modules.items.dto.ItemSummaryDto(" +
    ...
    @Query("SELECT new com.astraval.coreflow.main_modules.items.dto.SellableItemDto(" +
    ...
    @Query("SELECT new com.astraval.coreflow.main_modules.items.dto.PurchasableItemDto(" +
